...
const ROLES: RoleProfile[] = [
  ...
  {
    id: "systems-compiler",
    title: "Low-Level Systems & Compilers Engineer",
    level: "Staff",
    readinessPercentage: 88,
    description:
      "Deep specialization in custom memory allocators, AST parsers, bytecode interpreters, and hardware cache-conscious optimizations.",
    icon: Terminal,
    skills: [
      {
        name: "Custom Malloc & Free List Allocation",
        requiredScore: 190,
        currentScore: 218,
        status: "QUALIFIED",
        lessonId: "node-1-4",
        lessonTitle: "Custom Malloc Alignment & Segregated Free Lists",
      },
      {
        name: "Recursive Descent Parsing & Bytecode VM",
        requiredScore: 190,
        currentScore: 195,
        status: "QUALIFIED",
        lessonId: "node-1-8",
        lessonTitle: "Bytecode Stack Machine & Instruction Dispatch",
      },
      {
        name: "Cache-Conscious Data Structures & B-Trees",
        requiredScore: 180,
        currentScore: 165,
        status: "GAP",
        lessonId: "node-3-4",
        lessonTitle: "B-Tree Node Splitting & Disk Page Alignment",
      },
    ],
  },
];
